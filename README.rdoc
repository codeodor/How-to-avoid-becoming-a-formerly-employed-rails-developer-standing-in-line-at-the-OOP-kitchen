...
It's an appendix to a presentation I plan to give, and to which I'll link when I have a link available. (To any recording and/or slides)

The outline of the project is supposed to follow something like this:

1. Extract the typically bad parts out from an app I'm currently working on
...
If you want me to demonstrate it, get in touch with me at (insert contact info here) and tell me your idea.
